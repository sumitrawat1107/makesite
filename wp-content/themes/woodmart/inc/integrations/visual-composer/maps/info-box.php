	...
	function woodmart_get_info_box_shortcode_params() {
		...
		return apply_filters( 'woodmart_get_info_box_shortcode_params', array(
				...
				*/
				 ...
				 * Advanced.
				 */
				function_exists( 'woodmart_get_vc_animation_map' ) ? woodmart_get_vc_animation_map() : '',
				function_exists( 'woodmart_get_vc_animation_delay_map' ) ? woodmart_get_vc_animation_delay_map() : '',
				function_exists( 'woodmart_get_vc_animation_duration_map' ) ? woodmart_get_vc_animation_duration_map() : '',
			) 
		);
	}
}
